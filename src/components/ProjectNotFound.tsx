...
const ProjectNotFound = ({text}:any) => {
  return (
    <main className=" flex flex-col items-center justify-center mx-auto gap-[0.5rem] mb-[4rem] ">
      ...
      <Link to="/">
        <Button type="submit" variant="secondary" className=" mt-[1rem] text-secondary rounded-[3rem] px-[2rem] bg-gradient-to-r from-purple-500 to-indigo-500 hover:text-secondary font-semibold">Go Home</Button>
      </Link>
    </main>
  )
}
